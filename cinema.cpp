...
// variaveis de escolha de sess�o e filme
int qtd_filme = 4;
char sele_sessao;
...
void sessao_escolha(){
  ...
  while (opcao > qtd_filme || opcao < 0){
    ...
    case 1:
      while (escolha_hora > 2 || escolha_hora <= 0){
        ...
        if (escolha_hora > 2 || escolha_hora <= 0){
          cout << "\nN�o existe esse hor�rio, tente novamente" << endl;
        }
      }
    ...
    case 4:
      ...
      break;
    default:
      cout << "\nSess�o n�o existe, Tente novamente!" << endl;
      break;
    }
    loop_sessao = 0;
  }
...
void loop_hora(){
  ...
  while (loop_sessao != 1 && loop_sessao != 0){
    cout << endl;
    cout << "\n      SESS�O FILME                SELECIONAR POLTRONAS";
    ...
    while (loop_tela == 0){
      ...
      do{
        ...
        if (mostra_ing == guarda_polt){
          cout << "\nAten��o! � necess�rio comprovar este ingresso para entrar na sess�o.";
        }
...
void nomes_produtos(){
  ...
  nomes_prod[34] = "Fanta guar� 237ml";
  nomes_prod[35] = "Fanta guar� 350ml";
  nomes_prod[36] = "Fanta guar� ZERO 350ml";
  nomes_prod[37] = "Fanta guar� 600ml";
}
...
float escolha_tipo_comida(int escolha_comida){
  ...
  default:
    if (escolha_comida != 0){
      cout << "\nNumero inv�lido, Tente novamente" << endl;
    }
    break;
  }
...
void escolher_tipo_bc(){
  ...
  while (sele_comida != 'n' && sele_comida != 'N' && sele_comida != 's' && sele_comida != 'S'){
    cout << "\nDeseja entrar na op��es de comidas";
    cout << "\nDigite 'S' para SIM ou 'N' para 'N�O': ";
    cin >> sele_comida;
  }
  system("cls");
  ...
  if (loop_tela == 1 && sele_comida == 'n' || sele_comida == 'N'){
    ...
    while (sele_bebida != 'n' && sele_bebida != 'N' && sele_bebida != 's' && sele_bebida != 'S'){
      cout << "\nDeseja entrar na op��es de bebidas";
      cout << "\nDigite 'S' para SIM ou 'N' para 'N�O': ";
      cin >> sele_bebida;
    }
  }
  ...
  if (loop_tela == 1 && sele_bebida == 's' || sele_bebida == 'S' || escolha_comida == 0){
    if (sele_bebida == 's' || sele_bebida == 'S'){
      ...
      if(escolha_bebida != 0){
        while (loop_tela != 1 && loop_tela != 0){
          cout << endl;
          cout << "       OP��ES BEBIDAS                 FINALIZAR COMPRA";
          cout << "\n <- Digite 0 para voltar <-   -> Digite 1 para proseguir ->  ";
          cout << endl << "                            ";
          cin >> loop_tela;
          }
...
float soma_pipoca(int escolha_pipoca){
  ...
  case 1:
    while (opcao_pipoca < 0){
      ...
      system("cls");
      if (opcao_pipoca < 0){
        cout << "\nQuantidade inv�lida, tente novamente!" << endl;
      }
    }
